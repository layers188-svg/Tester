...
\echo ''
\echo '================================================================'
\echo ' House Dark - RLS policy tests (brief section 17)'
\echo '================================================================'
...
-- Fail the script (and therefore the npm task) if anything regressed.
do $$
declare
  v_failed integer;
  v_list text;
begin
  ...
  if v_failed > 0 then
    raise exception E'RLS TESTS FAILED: % assertion(s) did not hold:\n  %', v_failed, v_list;
  end if;
end
$$;
